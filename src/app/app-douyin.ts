...
import type { DouYin, DouYinInsert, DouYinUser, DouYinUserInsert, KoaContext, Lists, ResData } from '~/types'
...
export async function insertUser(res: KoaContext) {
    let json: ResData<Nullable<DouYinUser>>
    const reqBody = res.body as DouYinUserInsert
...
export async function insert(res: KoaContext) {
    ...
    const reqBody = res.body as DouYinInsert
